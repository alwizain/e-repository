...
cosine_sim_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/tf-idf/cosine_rating_sim.npz')
book_indices_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/tf-idf/indices.pkl')

# For Embedding
book_id_map_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/surprise/book_raw_to_inner_id.pickle')
book_raw_map_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/surprise/book_inner_id_to_raw.pickle')
book_embed_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/surprise/book_embedding.npy')
sim_books_path = os.path.join(settings.STATICFILES_DIRS[0] + '/model_files/surprise/sim_books.pickle')
...
cols = ['original_title', 'authors', 'average_rating', 'image_url', 'genre', 'desc', 'book_id']
...
def popular_among_users(N=50):
    ...
    """
    all_ratings = list(resources.models.UserRating.objects.all().order_by('-bookrating'))
