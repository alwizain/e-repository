...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_kategorij', models.AutoField(primary_key=True, serialize=False)),
                ('nama_kategori', models.CharField(max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Pengarang',
            fields=[
                ('id_pengarang', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Journal',
            fields=[
                ('kd_jurnal', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('kategorij', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resources.kategori_journal')),
            ],
        ),
        migrations.AddField(
            model_name='buku',
